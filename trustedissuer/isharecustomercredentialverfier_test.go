...
func TestIShareVerify(t *testing.T) {
	...
	tests := []test{
		{"Allow subjects if no role claim is configured.", []model.Claim{}, model.CredentialSubject{Id: "mySubject", IShareCredentialsSubject: &model.IShareCredentialsSubject{Roles: []model.Role{}}}, "did:test:issuer", true, model.HttpError{}},
		{"Allow subjects if only other claims are configured.", []model.Claim{{Name: "OTHER_CLAIM", AllowedValues: &[]model.AllowedValue{getAllowedCustomerValue()}}}, model.CredentialSubject{Id: "mySubject", IShareCredentialsSubject: &model.IShareCredentialsSubject{Roles: []model.Role{}}}, "did:test:issuer", true, model.HttpError{}},
		{"Allow subjects if claim allows the assigned role.", []model.Claim{{Name: ROLES_KEY, AllowedValues: &[]model.AllowedValue{getAllowedStringValue("CUSTOMER")}}}, model.CredentialSubject{Id: "mySubject", IShareCredentialsSubject: &model.IShareCredentialsSubject{Roles: []model.Role{{Names: []string{"CUSTOMER"}}}}}, "did:test:issuer", true, model.HttpError{}},
		{"Allow if more roles are allowed.", []model.Claim{{Name: ROLES_KEY, AllowedValues: &[]model.AllowedValue{getAllowedCustomerValue(), getAllowedEmployeeValue()}}}, model.CredentialSubject{Id: "mySubject", IShareCredentialsSubject: &model.IShareCredentialsSubject{Roles: []model.Role{{Names: []string{"EMPLOYEE"}}}}}, "did:test:issuer", true, model.HttpError{}},

		{"Reject if claim has empty allowed values.", []model.Claim{{Name: ROLES_KEY, AllowedValues: &[]model.AllowedValue{}}}, model.CredentialSubject{Id: "mySubject", IShareCredentialsSubject: &model.IShareCredentialsSubject{Roles: []model.Role{{Names: []string{"CUSTOMER"}}}}}, "did:test:issuer", false, model.HttpError{}},
		{"Reject if claim has different role allowed values.", []model.Claim{{Name: ROLES_KEY, AllowedValues: &[]model.AllowedValue{getAllowedEmployeeValue()}}}, model.CredentialSubject{Id: "mySubject", IShareCredentialsSubject: &model.IShareCredentialsSubject{Roles: []model.Role{{Names: []string{"CUSTOMER"}}}}}, "did:test:issuer", false, model.HttpError{}},
		...
		{"Allow subjects if no role-provider-claim is configured.", []model.Claim{}, model.CredentialSubject{Id: "mySubject", IShareCredentialsSubject: &model.IShareCredentialsSubject{Roles: []model.Role{{Names: []string{"TEST"}, Provider: "EU.EORI.HAPPYPETS", Target: "did:test:issuer"}}}}, "did:test:issuer", true, model.HttpError{}},
		{"Allow subjects if role-provider is allowed by the claim.", []model.Claim{{Name: ROLES_KEY, AllowedValues: &[]model.AllowedValue{getAlloweRoleValue(model.RoleValue{ProviderId: "EU.EORI.HAPPYPETS"})}}}, model.CredentialSubject{Id: "mySubject", IShareCredentialsSubject: &model.IShareCredentialsSubject{Roles: []model.Role{{Names: []string{"TEST"}, Provider: "EU.EORI.HAPPYPETS", Target: "did:test:issuer"}}}}, "did:test:issuer", true, model.HttpError{}},
		{"Allow subjects if role-provider is one of the allowed by the claim.", []model.Claim{{Name: ROLES_KEY, AllowedValues: &[]model.AllowedValue{getAlloweRoleValue(model.RoleValue{ProviderId: "EU.EORI.HAPPYPETS"}), getAlloweRoleValue(model.RoleValue{ProviderId: "EU.EORI.PACKETDELIVERY"})}}}, model.CredentialSubject{Id: "mySubject", IShareCredentialsSubject: &model.IShareCredentialsSubject{Roles: []model.Role{{Names: []string{"TEST"}, Provider: "EU.EORI.HAPPYPETS", Target: "did:test:issuer"}}}}, "did:test:issuer", true, model.HttpError{}},
		...
		{"Allow subjects if role, provider and ar are allowed.", []model.Claim{{Name: ROLES_KEY, AllowedValues: &[]model.AllowedValue{getAlloweRoleValue(model.RoleValue{Name: &[]string{"CUSTOMER"}, ProviderId: "EU.EORI.PACKETDELIVERY"})}}, {Name: AR_KEY, AllowedValues: &[]model.AllowedValue{getAllowedStringValue("EU.EORI.PACKETDELIVERY")}}}, model.CredentialSubject{Id: "mySubject", IShareCredentialsSubject: &model.IShareCredentialsSubject{Roles: []model.Role{{Names: []string{"CUSTOMER"}, Provider: "EU.EORI.PACKETDELIVERY", Target: "did:test:issuer"}}, AuthorizationRegistries: &map[string]model.AuthorizationRegistry{"EU.EORI.PACKETDELIVERY": {}}}}, "did:test:issuer", true, model.HttpError{}},

		{"Deny subjects if role is allowed for different provider, but provider not.", []model.Claim{{Name: ROLES_KEY, AllowedValues: &[]model.AllowedValue{getAlloweRoleValue(model.RoleValue{Name: &[]string{"CUSTOMER"}, ProviderId: "EU.EORI.OTHERPROVIDER"})}}}, model.CredentialSubject{Id: "mySubject", IShareCredentialsSubject: &model.IShareCredentialsSubject{Roles: []model.Role{{Names: []string{"CUSTOMER"}, Provider: "EU.EORI.PACKETDELIVERY", Target: "did:test:issuer"}}}}, "did:test:issuer", false, model.HttpError{}},
	}
