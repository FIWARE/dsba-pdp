...
func TestIShareVerify(t *testing.T) {
	...
	tests := []test{
		...
		{"Allow subjects if role and provider are allowed.", []model.Claim{{Name: ROLES_KEY, AllowedValues: &[]model.AllowedValue{getAlloweRoleValue(model.RoleValue{Name: &[]string{"CUSTOMER"}, ProviderId: "EU.EORI.PACKETDELIVERY"})}}}, model.CredentialSubject{Id: "mySubject", Roles: []model.Role{{Name: []string{"CUSTOMER"}, Provider: "EU.EORI.PACKETDELIVERY", Target: "did:test:issuer"}}}, "did:test:issuer", true, model.HttpError{}},
		{"Allow subjects if role, provider and ar are allowed.", []model.Claim{{Name: ROLES_KEY, AllowedValues: &[]model.AllowedValue{getAlloweRoleValue(model.RoleValue{Name: &[]string{"CUSTOMER"}, ProviderId: "EU.EORI.PACKETDELIVERY"})}}, {Name: AR_KEY, AllowedValues: &[]model.AllowedValue{getAllowedStringValue("EU.EORI.PACKETDELIVERY")}}}, model.CredentialSubject{Id: "mySubject", Roles: []model.Role{{Name: []string{"CUSTOMER"}, Provider: "EU.EORI.PACKETDELIVERY", Target: "did:test:issuer"}}, IShareCredentialsSubject: &model.IShareCredentialsSubject{AuthorizationRegistries: &map[string]model.AuthorizationRegistry{"EU.EORI.PACKETDELIVERY": {}}}}, "did:test:issuer", true, model.HttpError{}},

		{"Deny subjects if role is allowed for different provider, but provider not.", []model.Claim{{Name: ROLES_KEY, AllowedValues: &[]model.AllowedValue{getAlloweRoleValue(model.RoleValue{Name: &[]string{"CUSTOMER"}, ProviderId: "EU.EORI.OTHERPROVIDER"})}}}, model.CredentialSubject{Id: "mySubject", Roles: []model.Role{{Name: []string{"CUSTOMER"}, Provider: "EU.EORI.PACKETDELIVERY", Target: "did:test:issuer"}}}, "did:test:issuer", false, model.HttpError{}},
	}
