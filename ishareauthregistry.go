...
func getDelegationEvidence(issuer string, delegationTarget string, requiredPolicies *[]Policy, authorizationRegistry *AuthorizationRegistry) (delegeationEvidence *DelegationEvidence, httpErr httpError) {
	...
	delegationRequestBody := DelegationRequestWrapper{&DelegationRequest{PolicyIssuer: issuer, Target: &DelegationTarget{AccessSubject: delegationTarget}, PolicySets: []*PolicySet{&PolicySet{Policies: requiredPolicies}}}}
